...
import nl.tue.ddss.bimsparql.pfunction.PFuncListAndSimple;
...
public abstract class FunctionBase2Product extends PFuncListAndSimple{
	
	protected HashMap<Node, Geometry> hashmap;


	public FunctionBase2Product(HashMap<Node, Geometry> hashmap) {
		super();
